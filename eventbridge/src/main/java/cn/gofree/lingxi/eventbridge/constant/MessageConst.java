...
public class MessageConst {
    ...
    public static final String PROPERTY_TRANSIENT_TOPIC_CONFIG = "__RMQ.TRANSIENT.TOPIC_SYS_FLAG";
    public static final String PROPERTY_TRANSIENT_GROUP_CONFIG = "__RMQ.TRANSIENT.GROUP_SYS_FLAG";
    ...
    static {
        ...
        STRING_HASH_SET.add("POP_CK");
        STRING_HASH_SET.add("POP_CK_OFFSET");
        STRING_HASH_SET.add("1ST_POP_TIME");
        STRING_HASH_SET.add("TRAN_PREPARED_QUEUE_OFFSET");
        STRING_HASH_SET.add("DUP_INFO");
        STRING_HASH_SET.add("EXTEND_UNIQ_INFO");
        STRING_HASH_SET.add("INSTANCE_ID");
        STRING_HASH_SET.add("CORRELATION_ID");
        STRING_HASH_SET.add("REPLY_TO_CLIENT");
        STRING_HASH_SET.add("TTL");
        STRING_HASH_SET.add("ARRIVE_TIME");
        STRING_HASH_SET.add("PUSH_REPLY_TIME");
        STRING_HASH_SET.add("CLUSTER");
        STRING_HASH_SET.add("MSG_TYPE");
        STRING_HASH_SET.add("INNER_MULTI_QUEUE_OFFSET");
        STRING_HASH_SET.add("TIMER_DELAY_MS");
        STRING_HASH_SET.add("TIMER_DELAY_SEC");
        STRING_HASH_SET.add("TIMER_DELIVER_MS");
        STRING_HASH_SET.add("TIMER_ENQUEUE_MS");
        STRING_HASH_SET.add("TIMER_DEQUEUE_MS");
        STRING_HASH_SET.add("TIMER_ROLL_TIMES");
        STRING_HASH_SET.add("TIMER_OUT_MS");
        STRING_HASH_SET.add("TIMER_DEL_UNIQKEY");
        STRING_HASH_SET.add("TIMER_DELAY_LEVEL");
        STRING_HASH_SET.add("__BORNHOST");
        STRING_HASH_SET.add("BORN_TIMESTAMP");
        STRING_HASH_SET.add("DLQ_ORIGIN_TOPIC");
        STRING_HASH_SET.add("DLQ_ORIGIN_MESSAGE_ID");
    }
}
